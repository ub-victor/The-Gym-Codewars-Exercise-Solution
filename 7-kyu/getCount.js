...
This means you have:
    ...
    - A 5-liter flask
    - A 2-liter flask
Here our mission : to fill a tank that needs 14 liters, and we will choose only ine flask size which means We use only the 5-liter flask again and again and the last one be partial.
